...
During my PhD, I worked on [le Défricheur](https://ceres.huma-num.fr/defricheur/), a gamified annotation platform to help annotate UMWEs in a tweets dataset. As for now, this platform is only available in French. I also developed a tool for automatic unfrozen multiword identification in text: ASMR (Align, Segment, Match, Rank). 
